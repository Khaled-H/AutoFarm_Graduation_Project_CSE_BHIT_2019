...
extern void HAL_SWITCHES_TaskStateUpdate(void){
  ...
  HAL_SWITCHES_tStates temp;
  u8 i;
  u8 SwsPorts[SWITCHES_MAX_NUMBER]={HAL_SWITCHES_MODESW_PORT,HAL_SWITCHES_OKSW_PORT,HAL_SWITCHES_PLUSSW_PORT,HAL_SWITCHES_MINUSSW_PORT};
  u8 SwsPins[SWITCHES_MAX_NUMBER]={HAL_SWITCHES_MODESW_PIN,HAL_SWITCHES_OKSW_PIN,HAL_SWITCHES_PLUSSW_PIN,HAL_SWITCHES_MINUSSW_PIN};
